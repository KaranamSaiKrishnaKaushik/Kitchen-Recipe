...
namespace Data.Migrations
{
    ...
    [Migration("20250410052607_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataModels.Ingredient", b =>
                {
                    ...
                    b.Property<Guid>("BaseNameIdId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("BaseNameIdId");
            ...
            modelBuilder.Entity("DataModels.Ingredient", b =>
                {
                    b.HasOne("DataModels.IngredientBase", "BaseNameId")
                        .WithMany()
                        .HasForeignKey("BaseNameIdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BaseNameId");
                });
